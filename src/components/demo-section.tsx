...
// ── Chat widget preserved for future use ──────────────────────────────────────
...
// };
//
// Toggle JSX (paste inside the section to re-enable):
// <div className="mt-8 flex justify-center">
//   <div className="inline-flex items-center rounded-full border border-black/[.08] bg-[#f4f4f5] p-1">
//     <button onClick={() => setMode("voice")} className={`flex items-center gap-2 rounded-full px-5 py-2 text-sm font-medium transition-all ${mode === "voice" ? "bg-white text-zinc-900 shadow-sm" : "text-zinc-500 hover:text-zinc-700"}`}>
//       <Phone className="h-3.5 w-3.5" /> Voice Call
//     </button>
//     <button onClick={() => setMode("chat")} className={`flex items-center gap-2 rounded-full px-5 py-2 text-sm font-medium transition-all ${mode === "chat" ? "bg-white text-zinc-900 shadow-sm" : "text-zinc-500 hover:text-zinc-700"}`}>
//       <MessageSquare className="h-3.5 w-3.5" /> Chat Widget
//     </button>
//   </div>
// </div>
//
// Right column swap (replace static VoiceCallDemo below):
// {mode === "voice" ? <VoiceCallDemo /> : <div className="w-full max-w-sm"><DemoChatbot /></div>}
// ─────────────────────────────────────────────────────────────────────────────
